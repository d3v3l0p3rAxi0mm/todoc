...
public class TaskDaoTest {
    ...
    private final Task NEW_TASK_D = new Task(TARTAMPION_PROJECT_ID, "NEW TASK D (Tartampion), TS 10200", 10200);
    private final Task NEW_TASK_E = new Task(CIRCUS_PROJECT_ID, "NEW TASK E (Circus), TS 10200", 10200);
    ...
    public void getTasksByProject() throws InterruptedException {
        ...
        assertEquals(3, tasksAfterTasksCreating.size());
